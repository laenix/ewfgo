...
func (raid *RAID) Type() filesystem.FileSystemType {
	return filesystem.FS_RAID
}
...
func (raid *RAID) ListDirectory(path string) ([]filesystem.DirectoryEntry, error) {
...
func (raid *RAID) GetFileByPath(path string) (*filesystem.FileInfo, error) {
	return nil, fmt.Errorf("RAID: not a filesystem")
}

func (raid *RAID) SearchFiles(rootPath string, predicate func(filesystem.FileInfo) bool) ([]filesystem.FileInfo, error) {
	return nil, fmt.Errorf("RAID: not a filesystem")
}

func init() {
	filesystem.RegisterFileSystem(filesystem.FS_RAID, func() filesystem.FileSystem {
		return &RAID{}
	})
}
